 ...
 \end{center}
     ...
     \begin{itemize}
        \item \alert{What was the result?} \\
            \uncover<2->{Males tended to have taller socks than females,}
        \item \alert{How strong was the statistical support?} \\
            \uncover<3->{the difference was statistically significant ($P=0.03$),}
        \item \alert{What are the real-world implications?} \\
            \uncover<4->{but the results may not apply to other groups.}
     \end{itemize}
...
\begin{frame}{Example 2}
 ...
 \end{center}
     ...
     \begin{itemize}
        \item \alert{What was the result?} \\
            \uncover<2->{The treatment group had lower mean infection intensity,}
        \item \alert{How strong was the statistical support?} \\
            \uncover<3->{and there was good evidence the difference was not due to chance ($P=0.03$);}
        \item \alert{What are the real-world implications?} \\
            \uncover<4->{this provides good evidence that the treatment decreases infection intensity.}
     \end{itemize}
