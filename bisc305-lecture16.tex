...
\lecture[16]{the Paired sample $t$}{lecture-text}
...
\begin{frame}{Summary}
  \begin{enumerate}
    ...
    \item The \alert{paired-sample $t$} is just the $t$-test applied to differences;
    \item and the \alert{sign test} is very flexible, and doesn't even require numeric measurements
