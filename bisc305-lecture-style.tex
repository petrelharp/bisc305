...
% for aligning columns on decimal points:
%   http://tex.stackexchange.com/questions/2746/aligning-numbers-by-decimal-points-in-table-columns
%   http://tex.stackexchange.com/questions/140353/align-position-of-decimal-point-within-table-of-numbers-text-and-percentage-val?rq=1
\usepackage{dcolumn}
\newcolumntype{Y}{D..{3.2}}
...
\institute
{
{\small Office: 404C} \par\vskip2pt
