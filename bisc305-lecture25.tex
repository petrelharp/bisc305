...
% prediction and line-fitting
%   prediction
%   r as a function of prediciton
%   the SD line
%   look at local averages
%   the least-squares line via local averages
%   back to r
%   equation y = r s_y / s_x ( x - \bar x ) + \bar y 
% sum of squares
%   SSR
%   least-squares line
%   residual SD
%   r2 = proportion of variance explained = 1 - resid var / var y
